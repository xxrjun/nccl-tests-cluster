...
Options:
  ...
  -l, --log-dir <DIR>        Directory for logs. Default: benchmarks/<CLUSTER>/nccl-benchmark-results/single-node/runs/<RUN_ID>/without-debug/logs (or with-debug)
...
RESULTS_ROOT=${RESULTS_ROOT:-"$RESULTS_ROOT_BASE/single-node"}
