...
Usage
  Single directory mode:
    python summarize_nccl_logs.py --input benchmarks/example-cluster00/nccl-benchmark-results/pairwise/latest/with-debug/logs
    -> Generates summary.csv, summary.md in with-debug/ directory
    -> Generates failures.txt if any failures detected

  Batch mode:
    python summarize_nccl_logs.py --input benchmarks/example-cluster00/nccl-benchmark-results/pairwise/latest/
